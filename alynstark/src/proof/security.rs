...
mod tests {
    ...
    use super::crate::proof::ProofOptions;
    use crate::{crate::proof::security::ProvenSecurity, BatchingMethod, FieldExtension};
    ...
    fn get_100_bits_security() {
        ...
        let mut options = crate::proof::ProofOptions::new(
            num_queries,
            blowup_factor,
            grinding_factor,
            field_extension,
        ...
        options = crate::proof::ProofOptions::new(
            num_queries,
            blowup_factor,
            grinding_factor,
            field_extension,
