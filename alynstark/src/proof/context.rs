...
use crate::{crate::proof::ProofOptions, crate::proof::TraceInfo};
...
pub struct Context {
    ...
    options: crate::proof::ProofOptions,
...
impl Context {
    ...
    pub fn trace_info(&self) -> &crate::proof::TraceInfo {
        &self.trace_info
    }
    ...
    pub fn options(&self) -> &crate::proof::ProofOptions {
        &self.options
    }
...
impl Deserializable for Context {
    ...
    fn read_from<R: ByteReader>(source: &mut R) -> Result<Self, DeserializationError> {
        ...
        let trace_info = crate::proof::TraceInfo::read_from(source)?;
        ...
        // read options
        let options = crate::proof::ProofOptions::read_from(source)?;
...
mod tests {
    ...
    use super::{Context, Deserializable, crate::proof::ProofOptions, Serializable, ToElements, crate::proof::TraceInfo};
    ...
    fn context_to_elements() {
        ...
        let expected = {
            let trace_info = crate::proof::TraceInfo::new_multi_segment(
                main_width,
                aux_width,
                aux_rands,
                trace_length,
        ...
        let trace_info =
            crate::proof::TraceInfo::new_multi_segment(main_width, aux_width, aux_rands, trace_length, vec![]);
