...
use crate::{air::TransitionConstraintDegree, crate::proof::ProofOptions, crate::proof::TraceInfo};
...
pub struct AirContext<B: StarkField> {
    pub(super) options: crate::proof::ProofOptions,
    pub(super) trace_info: crate::proof::TraceInfo,
