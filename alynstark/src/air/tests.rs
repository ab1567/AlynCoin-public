...
impl MockAir {
    pub fn with_periodic_columns(
        ...
        let mut result = Self::new(
            crate::proof::TraceInfo::with_meta(4, trace_length, vec![1]),
            (),
        ...
        let mut result = Self::new(
            crate::proof::TraceInfo::with_meta(4, trace_length, vec![assertions.len() as u8]),
            (),
            crate::proof::ProofOptions::new(
                32,
                8,
...
pub fn build_context<B: StarkField>(
    ...
    let trace_info = crate::proof::TraceInfo::new(trace_width, trace_length);
