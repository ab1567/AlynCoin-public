...
use crate::crypto::{RandomCoin, RandomCoinError};

use crate::{BatchingMethod, crate::proof::ProofOptions};

mod aux;
pub use aux::AuxRandElements;

mod trace_info;
pub use trace_info::crate::proof::TraceInfo;
...
///   need to provide a [`crate::proof::TraceInfo`] which describes the shape of a multi-segment execution
///   trace.
...
pub trait Air: Send + Sync {
    ...
    /// by [crate::proof::ProofOptions] struct.
    ...
    fn new(trace_info: crate::proof::TraceInfo, pub_inputs: Self::PublicInputs, options: crate::proof::ProofOptions) -> Self;
