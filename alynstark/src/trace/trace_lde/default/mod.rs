...
use crate::air::{crate::proof::Queries, PartitionOptions, crate::proof::TraceInfo};
use crate::crypto::VectorCommitment;
...
/// LDE blowup factor, and the [crate::proof::TraceInfo].
///
