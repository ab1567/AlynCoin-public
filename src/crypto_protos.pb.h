...
Arena::CreateMaybeMessage<::alyncoin::AddressProto>(Arena *);
template <>
::alyncoin::CryptoKeysProto *
Arena::CreateMaybeMessage<::alyncoin::CryptoKeysProto>(Arena *);
template <>
::alyncoin::SignatureProto *
Arena::CreateMaybeMessage<::alyncoin::SignatureProto>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
namespace alyncoin {

// ===================================================================

class CryptoKeysProto final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:alyncoin.CryptoKeysProto)
                                                                       */
{
public:
  ...
  explicit PROTOBUF_CONSTEXPR
      CryptoKeysProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CryptoKeysProto(const CryptoKeysProto &from);
  CryptoKeysProto(CryptoKeysProto &&from) noexcept : CryptoKeysProto() {
    *this = ::std::move(from);
  }
...
private:
  ...
  _internal_set_private_key(const std::string &value);
...
private:
  ...
  inline PROTOBUF_ALWAYS_INLINE void
  _internal_set_public_key(const std::string &value);
...
class SignatureProto final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:alyncoin.SignatureProto)
                                                                      */
{
public:
  ...
  explicit PROTOBUF_CONSTEXPR
      SignatureProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SignatureProto(const SignatureProto &from);
  SignatureProto(SignatureProto &&from) noexcept : SignatureProto() {
    *this = ::std::move(from);
  }
...
class AddressProto final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:alyncoin.AddressProto)
                                                                    */
{
public:
  ...
  explicit PROTOBUF_CONSTEXPR
      AddressProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  AddressProto(const AddressProto &from);
  AddressProto(AddressProto &&from) noexcept : AddressProto() {
    *this = ::std::move(from);
  }
...
inline PROTOBUF_ALWAYS_INLINE void
CryptoKeysProto::set_private_key(ArgT0 &&arg0, ArgT... args) {

  _impl_.private_key_.SetBytes(static_cast<ArgT0 &&>(arg0), args...,
...
inline void
CryptoKeysProto::_internal_set_private_key(const std::string &value) {
...
inline void
CryptoKeysProto::set_allocated_private_key(std::string *private_key) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE void
CryptoKeysProto::set_public_key(ArgT0 &&arg0, ArgT... args) {

  _impl_.public_key_.SetBytes(static_cast<ArgT0 &&>(arg0), args...,
                              GetArenaForAllocation());
...
inline void
CryptoKeysProto::_internal_set_public_key(const std::string &value) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE void SignatureProto::set_signature(ArgT0 &&arg0,
                                                                 ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE void
AddressProto::set_miner_address(ArgT0 &&arg0, ArgT... args) {

  _impl_.miner_address_.Set(static_cast<ArgT0 &&>(arg0), args...,
                            GetArenaForAllocation());
...
inline void
AddressProto::_internal_set_miner_address(const std::string &value) {
...
inline void
AddressProto::set_allocated_miner_address(std::string *miner_address) {
