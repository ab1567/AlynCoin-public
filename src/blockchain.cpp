...
// Global mutex for blockchain safety. Recursive to avoid self-deadlocks when
// saveToDB() is invoked while already holding the lock in the same thread.
std::recursive_mutex blockchainMutex;
