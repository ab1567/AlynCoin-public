...
const char descriptor_table_protodef_blockchain_5fprotos_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "o\"a\n\017BlockchainProto\022\022\n\ndifficulty\030\001 \001(\005"
  "\022\024\n\014block_reward\030\002 \001(\001\022$\n\006blocks\030\003 \003(\0132\024"
  ".alyncoin.BlockProtob\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_blockchain_5fprotos_2eproto = {
    false, false, 188, descriptor_table_protodef_blockchain_5fprotos_2eproto,
...
BlockchainProto::BlockchainProto(const BlockchainProto& from)
  ...
  ::memcpy(&_impl_.block_reward_, &from._impl_.block_reward_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.difficulty_) -
    reinterpret_cast<char*>(&_impl_.block_reward_)) + sizeof(_impl_.difficulty_));
...
// @@protoc_insertion_point(message_clear_start:alyncoin.BlockchainProto)
  ...
  _impl_.blocks_.Clear();
  ::memset(&_impl_.block_reward_, 0, static_cast<size_t>(
...
uint8_t* BlockchainProto::_InternalSerialize(
  ...
  if (this->_internal_difficulty() != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(1, this->_internal_difficulty(), target);
  }
  ...
  if (raw_block_reward != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(2, this->_internal_block_reward(), target);
  }
...
void BlockchainProto::InternalSwap(BlockchainProto* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(BlockchainProto, _impl_.difficulty_)
      + sizeof(BlockchainProto::_impl_.difficulty_)
      - PROTOBUF_FIELD_OFFSET(BlockchainProto, _impl_.block_reward_)>(
          reinterpret_cast<char*>(&_impl_.block_reward_),
          reinterpret_cast<char*>(&other->_impl_.block_reward_));
}
