...
const ::_pbi::DescriptorTable descriptor_table_transaction_5fprotos_2eproto = {
    false, false, 153, descriptor_table_protodef_transaction_5fprotos_2eproto,
