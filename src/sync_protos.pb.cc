...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 7, -1, -1, sizeof(::alyncoin::SyncResponseProto)},
  { 15, -1, -1, sizeof(::alyncoin::BlockRequestProto)},
  { 22, -1, -1, sizeof(::alyncoin::BlockchainSyncProto)},
};
...
const ::_pbi::DescriptorTable descriptor_table_sync_5fprotos_2eproto = {
    false, false, 218, descriptor_table_protodef_sync_5fprotos_2eproto,
    "sync_protos.proto",
