...
// uint64 nonce = 14;
inline void TransactionProto::clear_nonce() {
  _impl_.nonce_ = uint64_t{0u};
}
inline uint64_t TransactionProto::_internal_nonce() const {
  return _impl_.nonce_;
}
inline uint64_t TransactionProto::nonce() const {
  // @@protoc_insertion_point(field_get:alyncoin.TransactionProto.nonce)
  return _internal_nonce();
}
inline void TransactionProto::_internal_set_nonce(uint64_t value) {
  
  _impl_.nonce_ = value;
}
inline void TransactionProto::set_nonce(uint64_t value) {
  _internal_set_nonce(value);
  // @@protoc_insertion_point(field_set:alyncoin.TransactionProto.nonce)
}
