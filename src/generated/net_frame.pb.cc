...
const uint32_t TableStruct_net_5fframe_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::alyncoin::net::SnapshotMeta, _impl_.chain_id_),
  PROTOBUF_FIELD_OFFSET(::alyncoin::net::SnapshotMeta, _impl_.genesis_hash_),
  PROTOBUF_FIELD_OFFSET(::alyncoin::net::SnapshotMeta, _impl_.tip_hash_),
  PROTOBUF_FIELD_OFFSET(::alyncoin::net::SnapshotMeta, _impl_.total_work_),
  PROTOBUF_FIELD_OFFSET(::alyncoin::net::SnapshotMeta, _impl_.digest_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::alyncoin::net::SnapshotEnd, _impl_.total_bytes_),
  PROTOBUF_FIELD_OFFSET(::alyncoin::net::SnapshotEnd, _impl_.digest_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 20, -1, -1, sizeof(::alyncoin::net::Ping)},
  { 26, -1, -1, sizeof(::alyncoin::net::Pong)},
  { 32, -1, -1, sizeof(::alyncoin::net::HeightRequest)},
  { 38, -1, -1, sizeof(::alyncoin::net::HeightResponse)},
  { 46, -1, -1, sizeof(::alyncoin::net::HeightProbe)},
  { 55, -1, -1, sizeof(::alyncoin::net::BlockBroadcast)},
  { 62, -1, -1, sizeof(::alyncoin::net::BlockBatch)},
  { 69, -1, -1, sizeof(::alyncoin::net::BlockRequest)},
  { 76, -1, -1, sizeof(::alyncoin::net::BlockResponse)},
  { 83, -1, -1, sizeof(::alyncoin::net::SnapshotMeta)},
  { 98, -1, -1, sizeof(::alyncoin::net::SnapshotChunk)},
  { 105, -1, -1, sizeof(::alyncoin::net::SnapshotAck)},
  { 112, -1, -1, sizeof(::alyncoin::net::SnapshotEnd)},
  { 120, -1, -1, sizeof(::alyncoin::net::TailBlocks)},
  { 127, -1, -1, sizeof(::alyncoin::net::EpochProof)},
  { 134, -1, -1, sizeof(::alyncoin::net::Inventory)},
  { 141, -1, -1, sizeof(::alyncoin::net::TipHashRequest)},
  { 147, -1, -1, sizeof(::alyncoin::net::TipHashResponse)},
  { 154, -1, -1, sizeof(::alyncoin::net::PeerListRequest)},
  { 160, -1, -1, sizeof(::alyncoin::net::PeerList)},
  { 167, -1, -1, sizeof(::alyncoin::net::RollupBlockMsg)},
  { 174, -1, -1, sizeof(::alyncoin::net::SnapshotRequest)},
  { 181, -1, -1, sizeof(::alyncoin::net::TailBlocksRequest)},
  { 189, -1, -1, sizeof(::alyncoin::net::GetData)},
  { 196, -1, -1, sizeof(::alyncoin::net::GetHeaders)},
  { 203, -1, -1, sizeof(::alyncoin::net::Headers)},
  { 210, -1, -1, sizeof(::alyncoin::net::StateProof)},
  { 217, -1, -1, sizeof(::alyncoin::net::TransactionBroadcast)},
  { 224, -1, -1, sizeof(::alyncoin::net::Whisper)},
  { 231, -1, -1, sizeof(::alyncoin::net::Frame)},
};
...
const char descriptor_table_protodef_net_5fframe_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "t_hash\030\002 \001(\t\022\023\n\013total_bytes\030\003 \001(\004\022\022\n\nchu"
  "nk_size\030\004 \001(\r\022\020\n\010chain_id\030\005 \001(\t\022\024\n\014genes"
  "is_hash\030\006 \001(\t\022\020\n\010tip_hash\030\007 \001(\014\022\022\n\ntotal"
  "_work\030\010 \001(\004\022\016\n\006digest\030\t \001(\014\"\035\n\rSnapshotC"
  "hunk\022\014\n\004data\030\001 \001(\014\"\032\n\013SnapshotAck\022\013\n\003seq"
  "\030\001 \001(\r\"2\n\013SnapshotEnd\022\023\n\013total_bytes\030\001 \001"
  "(\004\022\016\n\006digest\030\002 \001(\014\"2\n\nTailBlocks\022$\n\006bloc"
  "ks\030\001 \003(\0132\024.alyncoin.BlockProto\"\032\n\nEpochP"
  ...
  "ntil_hash\030\001 \001(\t\"=\n\021TailBlocksRequest\022\023\n\013"
  "from_height\030\001 \001(\004\022\023\n\013anchor_hash\030\002 \001(\t\"\031"
  "\n\007GetData\022\016\n\006hashes\030\001 \003(\t\"\037\n\nGetHeaders\022"
  "\021\n\tfrom_hash\030\001 \001(\t\"0\n\007Headers\022%\n\007headers"
  "\030\001 \003(\0132\024.alyncoin.BlockProto\"6\n\nStatePro"
  "of\022(\n\005proof\030\001 \001(\0132\031.alyncoin.StateProofP"
  "roto\">\n\024TransactionBroadcast\022&\n\002tx\030\001 \001(\013"
  "2\032.alyncoin.TransactionProto\"\027\n\007Whisper\022"
  "\014\n\004data\030\001 \001(\014\"\242\014\n\005Frame\022,\n\thandshake\030\001 \001"
  "(\0132\027.alyncoin.net.HandshakeH\000\022\"\n\004ping\030\002 "
  "\001(\0132\022.alyncoin.net.PingH\000\022\"\n\004pong\030\003 \001(\0132"
  "\022.alyncoin.net.PongH\000\0221\n\nheight_req\030\004 \001("
  "\0132\033.alyncoin.net.HeightRequestH\000\0222\n\nheig"
  "ht_res\030\005 \001(\0132\034.alyncoin.net.HeightRespon"
  "seH\000\0221\n\014height_probe\030\037 \001(\0132\031.alyncoin.ne"
  "t.HeightProbeH\000\0227\n\017block_broadcast\030\006 \001(\013"
  "2\034.alyncoin.net.BlockBroadcastH\000\022/\n\013bloc"
  "k_batch\030\007 \001(\0132\030.alyncoin.net.BlockBatchH"
  "\000\0223\n\rblock_request\030\035 \001(\0132\032.alyncoin.net."
  "BlockRequestH\000\0225\n\016block_response\030\036 \001(\0132\033"
  ".alyncoin.net.BlockResponseH\000\0223\n\rsnapsho"
  "t_meta\030\010 \001(\0132\032.alyncoin.net.SnapshotMeta"
  "H\000\0225\n\016snapshot_chunk\030\t \001(\0132\033.alyncoin.ne"
  "t.SnapshotChunkH\000\0221\n\014snapshot_ack\030\n \001(\0132"
  "\031.alyncoin.net.SnapshotAckH\000\0221\n\014snapshot"
  "_end\030\013 \001(\0132\031.alyncoin.net.SnapshotEndH\000\022"
  "/\n\013tail_blocks\030\014 \001(\0132\030.alyncoin.net.Tail"
  "BlocksH\000\022-\n\tagg_proof\030\r \001(\0132\030.alyncoin.n"
  "et.EpochProofH\000\022&\n\003inv\030\016 \001(\0132\027.alyncoin."
  "net.InventoryH\000\0224\n\014tip_hash_req\030\017 \001(\0132\034."
  "alyncoin.net.TipHashRequestH\000\0225\n\014tip_has"
  "h_res\030\020 \001(\0132\035.alyncoin.net.TipHashRespon"
  "seH\000\0226\n\rpeer_list_req\030\021 \001(\0132\035.alyncoin.n"
  "et.PeerListRequestH\000\022+\n\tpeer_list\030\022 \001(\0132"
  "\026.alyncoin.net.PeerListH\000\0224\n\014rollup_bloc"
  "k\030\023 \001(\0132\034.alyncoin.net.RollupBlockMsgH\000\022"
  "5\n\014snapshot_req\030\024 \001(\0132\035.alyncoin.net.Sna"
  "pshotRequestH\000\0223\n\010tail_req\030\025 \001(\0132\037.alync"
  "oin.net.TailBlocksRequestH\000\022/\n\013state_pro"
  "of\030\026 \001(\0132\030.alyncoin.net.StateProofH\000\022)\n\010"
  "get_data\030\027 \001(\0132\025.alyncoin.net.GetDataH\000\022"
  "@\n\027blockchain_sync_request\030\030 \001(\0132\035.alync"
  "oin.BlockchainSyncProtoH\000\022:\n\014tx_broadcas"
  "t\030\031 \001(\0132\".alyncoin.net.TransactionBroadc"
  "astH\000\022(\n\007whisper\030\032 \001(\0132\025.alyncoin.net.Wh"
  "isperH\000\022/\n\013get_headers\030\033 \001(\0132\030.alyncoin."
  "net.GetHeadersH\000\022(\n\007headers\030\034 \001(\0132\025.alyn"
  "coin.net.HeadersH\000B\006\n\004kindb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_net_5fframe_2eproto = {
    false, false, 3234, descriptor_table_protodef_net_5fframe_2eproto,
    "net_frame.proto",
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 42)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "alyncoin.net.SnapshotMeta.chain_id"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 50)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "alyncoin.net.SnapshotMeta.genesis_hash"));
        } else
          goto handle_unusual;
        continue;
      // bytes tip_hash = 7;
...
uint8_t* SnapshotMeta::_InternalSerialize(
  ...
  if (!this->_internal_chain_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "alyncoin.net.SnapshotMeta.chain_id");
    target = stream->WriteStringMaybeAliased(
  ...
  if (!this->_internal_genesis_hash().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "alyncoin.net.SnapshotMeta.genesis_hash");
    target = stream->WriteStringMaybeAliased(
  ...
  if (!this->_internal_tip_hash().empty()) {
    target = stream->WriteBytesMaybeAliased(
        7, this->_internal_tip_hash(), target);
  }

  // uint64 total_work = 8;
  if (this->_internal_total_work() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(8, this->_internal_total_work(), target);
  }

  // bytes digest = 9;
  if (!this->_internal_digest().empty()) {
    target = stream->WriteBytesMaybeAliased(
        9, this->_internal_digest(), target);
  }
...
void SnapshotEnd::InternalSwap(SnapshotEnd* other) {
  ...
  swap(_impl_.total_bytes_, other->_impl_.total_bytes_);
}
