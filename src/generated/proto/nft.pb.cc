...
static ::_pb::Metadata file_level_metadata_proto_2fnft_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_proto_2fnft_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_proto_2fnft_2eproto = nullptr;

const uint32_t TableStruct_proto_2fnft_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_proto_2fnft_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017proto/nft.proto\"\345\001\n\010NFTProto\022\n\n\002id\030\001 \001"
  "(\t\022\017\n\007creator\030\002 \001(\t\022\r\n\005owner\030\003 \001(\t\022\020\n\010me"
  "tadata\030\004 \001(\t\022\022\n\nimage_hash\030\005 \001(\t\022\021\n\ttime"
  "stamp\030\006 \001(\003\022\021\n\tsignature\030\007 \001(\014\022\026\n\016zk_sta"
  "rk_proof\030\010 \001(\014\022\017\n\007version\030\t \001(\t\022\020\n\010nft_t"
  "ype\030\n \001(\t\022\022\n\nproof_hash\030\013 \001(\t\022\022\n\nextra_d"
  "ata\030\014 \001(\tb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_proto_2fnft_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_proto_2fnft_2eproto = {
    false, false, 257, descriptor_table_protodef_proto_2fnft_2eproto,
    "proto/nft.proto",
    &descriptor_table_proto_2fnft_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_proto_2fnft_2eproto::offsets,
    file_level_metadata_proto_2fnft_2eproto, file_level_enum_descriptors_proto_2fnft_2eproto,
    file_level_service_descriptors_proto_2fnft_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_proto_2fnft_2eproto_getter() {
  return &descriptor_table_proto_2fnft_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_proto_2fnft_2eproto(&descriptor_table_proto_2fnft_2eproto);
...
::PROTOBUF_NAMESPACE_ID::Metadata NFTProto::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_proto_2fnft_2eproto_getter, &descriptor_table_proto_2fnft_2eproto_once,
      file_level_metadata_proto_2fnft_2eproto[0]);
}
