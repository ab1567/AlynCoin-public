...
quietPrint( "[DEBUG] Falcon Signature Length: " << sigFalcon.size() << "\n");
quietPrint( "[DEBUG] Dilithium Signature Length: " << sigDilithium.size() << "\n");
...
quietPrint( "[ZK] ❌ Proof generation failed (null optional).\n");
        return false;
    }

    zkProof = Crypto::fromHex(*proofStrOpt);
quietPrint( "[ZK] ✅ Proof generated. Size: " << zkProof->size() << " bytes\n");
...
quietPrint( "[DEBUG] Verifying Identity Signature...\n");
...
quietPrint( "  ✅ Falcon Valid: " << validFalcon << ", Dilithium Valid: " << validDilithium << "\n");
